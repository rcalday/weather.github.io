...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                'weather'=>App\GraphQL\Queries\QueryWeather::class,
                'location'=>App\GraphQL\Queries\QueryLocation::class
    ...
    'types' => [
        /* TYPES */
        'type_response'=> App\GraphQL\Types\TypeResponse::class,
        'type_weather'=> App\GraphQL\Types\TypeWeather::class,
        'type_location'=> App\GraphQL\Types\TypeLocation::class,
        /* INPUTS */
        'input_fields' => App\GraphQL\Inputs\InputFields::class
    ],
